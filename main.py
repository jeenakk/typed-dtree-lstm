...
def main():
    ...
    relset = sorted(set(Constants.TD_List))
    ...
    if os.path.isfile(train_file):
        ...
        train_dataset = SICKDataset(train_dir, vocab, args.num_classes,relset)
    ...
    if os.path.isfile(dev_file):
        ...
        dev_dataset = SICKDataset(dev_dir, vocab, args.num_classes,relset)
    ...
    if os.path.isfile(test_file):
        ...
        test_dataset = SICKDataset(test_dir, vocab, args.num_classes,relset)
    ...
    for epoch in range(args.epochs):
        ...
        if best < test_pearson:
            ...
            lossp.append(test_pearson)
            lossl.append(test_loss)
            lossmse.append(test_mse)
    # Function to plot 
    #plt.plot(x,y) 
